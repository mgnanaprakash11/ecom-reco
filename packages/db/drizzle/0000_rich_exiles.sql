...
ALTER TABLE "tenant_charge_tiers" ADD CONSTRAINT "tenant_charge_tiers_charge_config_id_tenant_charge_configs_id_fk" FOREIGN KEY ("charge_config_id") REFERENCES "public"."tenant_charge_configs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "cost_entries_tenant_idx" ON "cost_entries" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "cost_entries_type_idx" ON "cost_entries" USING btree ("cost_type");--> statement-breakpoint
CREATE INDEX "cost_entries_order_item_idx" ON "cost_entries" USING btree ("order_item_id");--> statement-breakpoint
CREATE INDEX "cost_entries_order_return_idx" ON "cost_entries" USING btree ("order_return_id");--> statement-breakpoint
CREATE INDEX "data_upload_batches_tenant_idx" ON "data_upload_batches" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "data_upload_batches_tenant_platform_idx" ON "data_upload_batches" USING btree ("tenant_platform_id");--> statement-breakpoint
...
CREATE INDEX "ledger_entries_tax_section_idx" ON "ledger_entries" USING btree ("tax_section");--> statement-breakpoint
...
CREATE INDEX "logistics_disputes_tenant_idx" ON "logistics_disputes" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "logistics_disputes_order_idx" ON "logistics_disputes" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "logistics_disputes_status_idx" ON "logistics_disputes" USING btree ("status");--> statement-breakpoint
CREATE INDEX "order_charge_allocations_order_idx" ON "order_charge_allocations" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "order_charge_allocations_charge_idx" ON "order_charge_allocations" USING btree ("charge_type");--> statement-breakpoint
CREATE INDEX "order_items_order_idx" ON "order_items" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "order_returns_tenant_idx" ON "order_returns" USING btree ("tenant_id");--> statement-breakpoint
...
CREATE INDEX "orders_tenant_platform_idx" ON "orders" USING btree ("tenant_platform_id");--> statement-breakpoint
CREATE UNIQUE INDEX "orders_tenant_order_key" ON "orders" USING btree ("tenant_id","tenant_platform_id","external_order_id");--> statement-breakpoint
CREATE INDEX "payment_adjustments_payment_idx" ON "payment_adjustments" USING btree ("payment_id");--> statement-breakpoint
CREATE INDEX "payment_adjustments_tax_section_idx" ON "payment_adjustments" USING btree ("tax_section");--> statement-breakpoint
CREATE INDEX "payment_order_allocations_payment_idx" ON "payment_order_allocations" USING btree ("payment_id");--> statement-breakpoint
CREATE INDEX "payment_order_allocations_order_idx" ON "payment_order_allocations" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "payments_tenant_idx" ON "payments" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "payments_tenant_platform_idx" ON "payments" USING btree ("tenant_platform_id");--> statement-breakpoint
CREATE UNIQUE INDEX "payments_tenant_payment_key" ON "payments" USING btree ("tenant_id","tenant_platform_id","payment_reference");--> statement-breakpoint
CREATE INDEX "payments_utr_idx" ON "payments" USING btree ("utr_number");--> statement-breakpoint
CREATE INDEX "payments_payout_batch_idx" ON "payments" USING btree ("payout_batch_id");--> statement-breakpoint
CREATE INDEX "pg_disputes_tenant_idx" ON "pg_disputes" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "pg_disputes_payment_idx" ON "pg_disputes" USING btree ("payment_id");--> statement-breakpoint
CREATE INDEX "pg_disputes_status_idx" ON "pg_disputes" USING btree ("status");--> statement-breakpoint
CREATE INDEX "platform_claims_tenant_idx" ON "platform_claims" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "platform_claims_status_idx" ON "platform_claims" USING btree ("status");--> statement-breakpoint
CREATE INDEX "platform_claims_order_idx" ON "platform_claims" USING btree ("order_id");--> statement-breakpoint
CREATE UNIQUE INDEX "platforms_code_key" ON "platforms" USING btree ("code");--> statement-breakpoint
CREATE INDEX "profitability_snapshots_tenant_idx" ON "profitability_snapshots" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "profitability_snapshots_order_idx" ON "profitability_snapshots" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "profitability_snapshots_tenant_platform_idx" ON "profitability_snapshots" USING btree ("tenant_platform_id");--> statement-breakpoint
CREATE INDEX "profitability_snapshots_run_idx" ON "profitability_snapshots" USING btree ("reconciliation_run_id");--> statement-breakpoint
CREATE INDEX "profitability_snapshots_segment_idx" ON "profitability_snapshots" USING btree ("segment_key");--> statement-breakpoint
CREATE INDEX "profitability_snapshots_campaign_idx" ON "profitability_snapshots" USING btree ("campaign_identifier");--> statement-breakpoint
CREATE INDEX "profitability_snapshots_period_idx" ON "profitability_snapshots" USING btree ("period_start","period_end");--> statement-breakpoint
CREATE INDEX "reconciliation_entries_run_idx" ON "reconciliation_entries" USING btree ("run_id");--> statement-breakpoint
CREATE INDEX "reconciliation_entries_status_idx" ON "reconciliation_entries" USING btree ("status");--> statement-breakpoint
CREATE INDEX "reconciliation_runs_tenant_idx" ON "reconciliation_runs" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "settlement_lines_settlement_idx" ON "settlement_lines" USING btree ("tenant_platform_id","settlement_reference");--> statement-breakpoint
CREATE INDEX "settlement_lines_order_idx" ON "settlement_lines" USING btree ("order_external_id");--> statement-breakpoint
CREATE INDEX "settlement_lines_type_idx" ON "settlement_lines" USING btree ("line_type");--> statement-breakpoint
CREATE INDEX "statutory_credits_tenant_period_idx" ON "statutory_credits" USING btree ("tenant_id","period_year","period_month");--> statement-breakpoint
CREATE UNIQUE INDEX "tenant_charge_configs_unique_version" ON "tenant_charge_configs" USING btree ("tenant_platform_id","charge_type","version");--> statement-breakpoint
CREATE INDEX "tenant_charge_configs_tenant_platform_idx" ON "tenant_charge_configs" USING btree ("tenant_platform_id");--> statement-breakpoint
CREATE INDEX "tenant_charge_configs_product_category_idx" ON "tenant_charge_configs" USING btree ("tenant_platform_id","product_category");--> statement-breakpoint
CREATE INDEX "tenant_charge_configs_fulfillment_idx" ON "tenant_charge_configs" USING btree ("tenant_platform_id","fulfillment_channel");--> statement-breakpoint
CREATE INDEX "tenant_charge_configs_shipping_zone_idx" ON "tenant_charge_configs" USING btree ("shipping_zone");--> statement-breakpoint
CREATE INDEX "tenant_charge_tiers_charge_config_idx" ON "tenant_charge_tiers" USING btree ("charge_config_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "tenant_platforms_tenant_platform_key" ON "tenant_platforms" USING btree ("tenant_id","platform_id");--> statement-breakpoint
CREATE INDEX "tenant_platforms_tenant_idx" ON "tenant_platforms" USING btree ("tenant_id");--> statement-breakpoint
